...
marks2 = [61,45,100,57,64,56,77,64,67,11]
...
#confused by the results. The first array contains the list of row numbers 
#and second array respective column numbers, which mean z[55][1]
...
#The data point where we have False that means these values are valid whereas 
